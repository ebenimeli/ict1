# Class 01. Responsible use of technology
...
1. **Read** carefully the document _Responsible Digital Relationships_.
2. **Write down** the words and expressions you do not understand and look up their meaning. You may use the online dictionary WordReference, but do not use an automatic translator.
3. **Answer** the questions in activity E02 on Microsoft Teams.

## Text: _Responsible Digital Relationships_

![Connections](class01/connections.jpg)

[Download text and glossary](class01/text_responsible_dig_relation.pdf)
